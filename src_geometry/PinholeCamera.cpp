...
PinholeCamera::PinholeCamera( string config_file )
{
  ...
  if( !fs.isOpened() )
  {
    cout << "Cannot open config file : %s", config_file.c_str() ;
    cout << "Quit";
    mValid = false;
    exit(1);
  }
...
{
    cout << "[PinholeCamera::PinholeCamera] Setting camera intrinsics explicitly.....\n";
    ...
    cout << "[PinholeCamera::PinholeCamera] ... Done setting camera intrinsics explicitly.....\n";
}
