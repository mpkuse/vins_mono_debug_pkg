...
std::shared_ptr<StereoGeometry> make_stereo_geom()
{
    ...
    //----------- Stereo Base line load (alsoed called extrinsic calibration)
        // mynt eye
    Vector4d q_xyzw = Vector4d( -7.8278125678242136e-04,2.4666921736014214e-03,-1.4477856356187120e-03,9.9999560329032322e-01 );
    Vector3d tr_xyz = Vector3d( -1.1985630585227842e+02/1000.,1.2186198275182303e-01/1000., -1.4431533628123798e+00/1000. );
